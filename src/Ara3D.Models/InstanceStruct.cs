...
public unsafe struct InstanceStruct
{
    ...
    public Matrix4x4 Matrix4x4
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => new(
            Row0.X, Row1.X, Row2.X, 0f,
            Row0.Y, Row1.Y, Row2.Y, 0f,
            Row0.Z, Row1.Z, Row2.Z, 0f,
            0f, 0f, 0f, 1f);
        ...
        set
        {
            Row0 = (value.M11, value.M21, value.M31, value.M41);
            Row1 = (value.M12, value.M22, value.M32, value.M42);
            Row2 = (value.M13, value.M23, value.M33, value.M43);
        }
    }
}