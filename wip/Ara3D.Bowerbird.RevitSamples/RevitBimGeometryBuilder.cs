...
{
    public BimGeometry Build()
    {   
        var bldr = new BimGeometryBuilder();
    ...
    public MeshGroup ProcessGeometryObject(GeometryObject geom)
    {
        ...
        // Things like lines, curves, profiles, etc. all return null
        return null;
    }
            ...
            try
            {
                ...
                if (includeLinks)
                {
                                 ...
                                 .OfType<RevitLinkInstance>())
                    {
                        ...
                        var tmp = ProcessDocument(linkDoc, includeLinks);
