...
{
    /*
    public class BowerbirdLayoutImporter : Bowerbird.NamedCommand, IDirectContext3DServer
    {
        ...
        public Dictionary<int, Vector3> RoomCenters = new Dictionary<int, Vector3>();
        public Dictionary<int, Vector3> DoorCenters = new Dictionary<int, Vector3>();
        ...
        public void UpdateMeshAndBoundingBoxFromScene(Ara3D.Model3D scene)
        {
            Mesh = scene.();
                ToRenderMesh();
            if (Mesh != null)
        ...
        public void AddArrowsFromLine(SceneNode root, IEnumerable<Line3D> lines)
        {
            ...
            foreach (var line in lines)
            {
                ...
                var rot = dir.LookRotation(Vector3.UnitZ);
